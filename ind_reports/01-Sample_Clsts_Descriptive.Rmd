...
all_flows_plotObj_noleg <- all_flows_plotObj + theme(legend.position = "none")
high_flows_plotObj_noleg <- high_flows_plotObj + theme(legend.position = "none")
toprow <- cowplot::plot_grid(smplocations.nolegend, roadnetworkplotObj, 
                             all_flows_plotObj_noleg, high_flows_plotObj_noleg,
                             nrow = 2, ncol = 2, labels = c("(A)", "(B)", "(C)", "(D)"))
legend <- cowplot::get_legend(all_flows_plotObj +
                                theme(legend.position = "bottom",
                                      plot.margin = unit(c(0.05, 0.05, 0.05, 0.05),"cm")))
# bring together
MainFig <- cowplot::plot_grid(toprow, legend, rel_heights = c(0.95, 0.5), ncol = 1)
