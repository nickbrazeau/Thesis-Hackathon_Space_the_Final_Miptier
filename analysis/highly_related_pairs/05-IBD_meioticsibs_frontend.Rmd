...
```{r}
#..............................................................
# River and IBD long distances
# i.e. supp fig that SRM likes
#..............................................................
# save this out for plotting later
drcrivers.simp <- readRDS("data/derived_data/river_network.RDS")

drcrivers.simp <- drcrivers.simp %>% 
  dplyr::filter(!is.na(name)) %>% 
  dplyr::filter(name %in% c("Congo", "Lualaba", "Lwalaba", "Ubangi", # congo river
                            "Kasai", "Kasaï", "Sankuru", # offset down
                            "Ubangi", "Uele", "Aruwimi",
                            "Tshuapa", "Lomami", "Luvua", "Luvu", "Luvula",
                            "Busira", "Ruki"
                            )) 
 

long_trans_plot.river <- ggplot() +
  geom_sf(data = DRCprov, color = "#737373", fill = "#525252", size = 0.05) +
  geom_sf(data = drcrivers.simp, color = "#9ecae1", size = 1.1) +
  prettybasemap_nodrc_dark + 
  geom_curve(data = notsameclst.edges,
             aes(x = long_jitter.x, y = lat_jitter.x, 
                 xend = long_jitter.y, yend = lat_jitter.y, 
...
jpeg("~/Documents/GitHub/Space_the_Final_Miptier/results/figures/DRC_network_long_trans_map_rivers.jpg",
     height = 8, width = 11, units = "in", res = 500)
plot(long_trans_plot.river)
graphics.off()
