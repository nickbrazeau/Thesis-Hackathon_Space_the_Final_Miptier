...
jpeg("~/Documents/GitHub/Space_the_Final_Miptier/results/figures/provibD_within_alone.jpg", width = 11, height = 8, units = "in", res = 600)
plot(DRC.Provwthn.plotObj)
graphics.off()
```
