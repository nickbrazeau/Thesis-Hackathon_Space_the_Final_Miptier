...
```
```{r}
vcf <- vcfR::read.vcfR(file = "~/Documents/GitHub/Space_the_Final_Miptier/data/derived_data/bigbarcode_genetic_data/polarized_biallelic_processed.wsaf.vcf.bgz")
vcf.DRC <- vcfRmanip::select_samples(vcf, smplvctr = unlist(mtdt$id))
vcf.DRC <- vcf.DRC[vcfR::is.biallelic(vcf.DRC), ]
```
```{r}
...
jpeg("~/Documents/GitHub/Space_the_Final_Miptier/results/figures/LD_snp_correlationplot.jpg",
