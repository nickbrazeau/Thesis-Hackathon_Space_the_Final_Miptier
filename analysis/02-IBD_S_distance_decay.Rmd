...
### IBD Decay Plots - Continuous, Facet Province
...
### IBD Decay Plots - Means, Facet Province
...
jpeg("~/Documents/GitHub/Space_the_Final_Miptier/results/figures/IBD_decay_plot_meanIBD_adm1_zoom.jpg",
     unit = "in", height = 25, width = 11, res = 500)
plot(IBDdecay.plot)
graphics.off()
