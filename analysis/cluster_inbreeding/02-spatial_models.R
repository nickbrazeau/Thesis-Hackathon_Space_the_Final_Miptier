...
# read in data
#..............................................................
clst_inbd <- readRDS("data/derived_data/clst_inbreeding_dat/clst_inbreeding_runs.RDS")
clst_inbd <- clst_inbd %>%
  tidyr::gather(., key = "hv001", value = "Fclst", 1:ncol(.))
...
clst_inbd_f <- dplyr::left_join(clst_inbd_f, clsts, by = "hv001")
...
Fclst_raster <- fit_pred_spMLE(data = clst_inbd_f,
